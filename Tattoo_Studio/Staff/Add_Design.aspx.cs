    ...
    public partial class Add_Design : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (txtimage.HasFile)
            {
                ...
                string image = "image/" + strname;
               
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into tblDesign values('" + txtdesign.Text + "','" +txtprice.Text + "','" +  image + "','"+txtCatID.SelectedItem .Value  +"')", con);
                cmd.ExecuteNonQuery();
                con.Close();
