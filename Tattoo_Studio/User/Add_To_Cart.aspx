...
<body>
    <form id="form1" runat="server">
        <div>
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" Height="321px" ShowFooter="True" Width="1000px" CssClass="grid1" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting">
